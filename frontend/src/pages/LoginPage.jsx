...
export default function LoginPage() {
    ...
    const [email, setEmail] = useState("admin@horizonschool.com");
    ...
    return (
        <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4 sm:p-6 lg:p-8 font-body">
            {/* Colorful animated blob background */}
            <div className="absolute inset-0 bg-gradient-to-br from-indigo-100 via-white to-orange-100" />
            <div className="absolute top-[-10%] left-[-10%] w-[60vw] h-[60vw] rounded-full bg-[#4A3FBF]/25 blur-3xl" />
            <div className="absolute bottom-[-15%] right-[-10%] w-[55vw] h-[55vw] rounded-full bg-[#F39C2A]/30 blur-3xl" />
            <div className="absolute top-1/3 right-1/4 w-72 h-72 rounded-full bg-pink-400/20 blur-3xl" />
            <div className="absolute inset-0 hero-grid-bg opacity-40" />

            <div className="relative z-10 w-full max-w-5xl grid lg:grid-cols-2 gap-8 items-center">
                {/* Left: Big logo + branding */}
                <div className="text-center lg:text-left space-y-6 px-4">
                    ...
                    <div>
                        ...
                        <p className="mt-4 text-slate-600 max-w-md mx-auto lg:mx-0">
                            A nurturing space where curious little minds blossom. Manage your Day-Care, Pre-Nursery, Nursery, LKG and UKG programs effortlessly.
                        </p>
                    </div>
                ...
                <div className="glass-card rounded-3xl shadow-2xl border border-white/60 p-8 sm:p-10">
                    <div className="mb-6 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-500">Admin & Staff portal</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            ...
                            className="w-full bg-[#4A3FBF] hover:bg-[#3a3199] text-white font-semibold rounded-xl px-6 py-3.5 transition-all shadow-lg hover:shadow-xl disabled:opacity-60 flex items-center justify-center gap-2"
                        >
